...
describe('TC-M01-091 - Notificación de cambio de contraseña en dos canales', () => {
  ...
  it('muestra en la bandeja interna el evento CAMBIO_CONTRASENA', () => {
    ...
    cy.intercept('GET', 'https://sigab-backendtest-389pcb-a48238-158-69-200-27.sslip.io/api-sgpmp-test/notificaciones*').as('notifications');
  ...
  afterEach(() => {
    ...
    cy.task('writeResult', {
      file: 'EvaluacionV2/RESULTADOS/TC-M01-091/TC-M01-091_resultado.json',
      content: JSON.stringify(result, null, 2),
    });
    cy.task('writeResult', {
      file: 'EvaluacionV2/RESULTADOS/TC-M01-091/TC-M01-091_resultado.md',
